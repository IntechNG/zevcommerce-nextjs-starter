...
export default function CheckoutPage() {
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-text-primary mb-6">Checkout</h1>
                                    ...
                                    {shippingRates.map(rate => (
                                        <label
                                            ...
                                            className={`flex items-center justify-between p-4 rounded-lg border cursor-pointer transition-colors ${
                                                selectedRateId === rate.id ? 'border-brand bg-brand-50' : 'border-border-light hover:border-brand/30'
                                            }`}
                                        >
                                    ...
                                    {paymentMethods.map(method => (
                                        <label
                                            ...
                                            className={`block p-4 rounded-lg border cursor-pointer transition-colors ${
                                                selectedPayment === method.provider ? 'border-brand bg-brand-50' : 'border-border-light hover:border-brand/30'
                                            }`}
                                        >
                                            <div className="flex items-center gap-3">
                                                <input
